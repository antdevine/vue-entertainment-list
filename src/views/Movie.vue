<template>
    <div>
        <h2>{{ movieData[$route.params.movieid].title }}</h2>
        
        <img :src="movieData[$route.params.movieid].thumbnail.regular.medium" />

        {{ movieData[$route.params.movieid].year }}

        {{ movieData[$route.params.movieid].category }}

        {{ movieData[$route.params.movieid].rating }}

        {{ movieData[$route.params.movieid].isBookmarked }}

        {{ movieData[$route.params.movieid].isTrending }}
    </div>
</template>
